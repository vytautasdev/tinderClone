    ...
    <View style={[tw("h-full bg-red-500 pt-20"), { opacity: 0.89 }]}>
      ...
      <View>
        <Text style={tw("text-center text-white mt-5")}>
          You and {userSwiped.displayName.split(" ")[0]} have liked each other.
        </Text>
        <Text style={tw("text-center text-white mt-0")}>
          Start messaging right away!
        </Text>
      </View>

      <View style={tw("flex-row justify-evenly px-10 pt-20")}>
        <Image
